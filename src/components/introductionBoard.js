...
export const  IntroductionBoard= (props) =>{
    const strings = ['solve your company problems and elevate your brand', 'develop custom software to streamline your operations', 'design engaging websites to attract more customers'];
    return( 
    <section id="introduction-board" className="row container-fluid mx-0 px-0">
       <div className="ib-left-side col-md-7 d-flex flex-column ">
            <h1 className="mt-4"><span className="service-type-intro">Apps. <br/> Websites. <br/>  Softwares.<br/></span> <p className="header-second-title"> We solve your company problems and elevate your brand.</p></h1>
